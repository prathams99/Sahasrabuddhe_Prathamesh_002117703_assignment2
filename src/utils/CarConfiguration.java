...
public class CarConfiguration {
    ...
    private CarConfiguration () {
        ...
        CarProperties car1 = new CarProperties("Hyundai", "Elantra", "Boston", 123, 5, 1, false, 2018, true, yourDate);
        CarProperties car2 = new CarProperties("Hyundai", "Tucson", "Boston", 234, 7, 1, true, 2020, true, yourDate);
